...
import 'package:jalali_flutter_datepicker/src/date/shamsi_date.dart';
...
const double _monthNavButtonsWidth = 50.0;
...
class PCalendarDatePicker extends StatefulWidget {
  ...
  PCalendarDatePicker({
    ...
    required this.footerTextStyle,
        ...
        super(key: key) {
    if (this.lastDate.isBefore(this.firstDate)) {
      throw FlutterError(
        'تاریخ پایان ${this.lastDate} باید برابر یا بعد از تاریخ شروع ${this.firstDate} باشد.',
      );
    }
    if (this.initialDate.isBefore(this.firstDate)) {
      throw FlutterError(
        'تاریخ اولیه ${this.initialDate} باید برابر یا بعد از تاریخ شروع ${this.firstDate} باشد.',
      );
    }
    if (this.initialDate.isAfter(this.lastDate)) {
      throw FlutterError(
        'تاریخ اولیه ${this.initialDate} باید برابر یا قبل از تاریخ پایان ${this.lastDate} باشد.',
      );
    }
    if (selectableDayPredicate != null &&
        !selectableDayPredicate!(this.initialDate)) {
      throw FlutterError(
        'تاریخ اولیه ${this.initialDate} باید شرایط قابل انتخاب بودن را برآورده کند.',
      );
    }
  }
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    tooltip:
                        _isDisplayingFirstMonth ? null : previousTooltipText,
                    onPressed:
...
class _DayPicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //final Color todayColor = Colors.red;
